...
import { MapPin, Phone, Mail, Loader2, CheckCircle2, X, AlertCircle, Globe } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12 max-w-6xl mx-auto">
          ...
          <motion.div 
            ...
            className="space-y-8"
          >
            <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Let's learn and grow together.</h3>
            <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
              Whether you're an individual looking to develop new skills or an organization seeking training solutions, our team is ready to help you achieve your goals.
            </p>
            
            <div className="space-y-6 mt-8">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white dark:bg-dark-card rounded-xl text-orange-500 shadow-sm">
                  <MapPin className="w-6 h-6"/>
                </div>
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white text-lg">Our Location</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-1">+251 968 331 095</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 bg-white dark:bg-dark-card rounded-xl text-orange-500 shadow-sm">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white text-lg">Website</h4>
                  <p className="text-gray-600 dark:text-gray-400 mt-1">www.kutalearninghub.com</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 text-left">
                  ...
                  <input 
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-dark-border bg-gray-50 dark:bg-dark-bg focus:ring-2 focus:ring-orange-500 focus:outline-none dark:text-white transition-all" 
                    placeholder="John" 
                  />
                </div>
                <div className="space-y-2 text-left">
              ...
              <div className="space-y-2 text-left">
                ...
                <textarea 
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-dark-border bg-gray-50 dark:bg-dark-bg focus:ring-2 focus:ring-orange-500 focus:outline-none dark:text-white transition-all resize-none" 
